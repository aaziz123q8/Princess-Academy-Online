import{S as e}from"./index-DdQYT3cP.js";import"./logDepthDeclaration-Zn7HmxDa.js";import"./imageProcessingFunctions-byABlXOu.js";import"./clipPlaneFragment-ByO9EOUO.js";import"./fogFragment-DBlH17yF.js";const t="prePassDeclaration",g=`#ifdef PREPASS
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=x);const o="lightUboDeclaration",w=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
vec3f( 0,1,0 ),
vec3f( 0,0,1 )
);result.Diffuse+=LTCEvaluate( normal,viewDir,position,mInvEmpty,rectCoords0,rectCoords1,rectCoords2,rectCoords3 );return result;}`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=C);const f="lightsFragmentFunctions",L=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=P);const p="depthPrePass",X=`#ifdef DEPTHPREPASS
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=X);const u="lightFragment",M=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=M);const h="logDepthFragment",_=`#ifdef LOGARITHMICDEPTH
