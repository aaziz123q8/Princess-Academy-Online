import{S as e}from"./index-DdQYT3cP.js";import"./logDepthDeclaration-D7FDb9hv.js";import"./helperFunctions-CwtxDJxE.js";import"./imageProcessingFunctions-DnhmL3dG.js";import"./fogFragment-DWQ0BqgT.js";import"./meshUboDeclaration-BPXW5QnG.js";const o="decalFragmentDeclaration",L=`#ifdef DECAL
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=P);const l="lightUboDeclaration",X=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=x);const s="lightsFragmentFunctions",F=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=F);const d="shadowsFragmentFunctions",M=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=M);const c="samplerFragmentDeclaration",R=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=R);const h="fresnelFunction",N=`#ifdef FRESNEL
